...
<body>
<form class="layui-form" action="addBookServlet" style="text-align: center; margin-top: 300px;width:600px; width:600px;" method="post">
...
<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="state" required lay-verify="required" placeholder="请输入描述" autocomplete="off" class="layui-input">
				</div>
			</div>
				<div class="layui-form-item">
					<div class="layui-input-block">
