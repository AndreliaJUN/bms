...
<div class="page-container">
			...
			<form action="loginServlet" method="post" style="text-align: center;">
				...
				<br>
				<div class="danxuan">
				<span><input type="radio" class="radio" name="shenfen" value="manager">manager</span>
				<span><input type="radio" class="radio" name="shenfen" value="user">user</span>
				</div>
				<div class="button" style="text-align: center;"> <button type="submit">login</button></div>
				<div class="register"><a href="register.jsp">没有账号，点击注册</a></div>
			</form>
		</div>
