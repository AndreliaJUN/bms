...
<body>
<form class="layui-form" action="modifyBookServlet2" style="text-align: center; margin-top: 300px;width:600px;" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="ISBN2" required lay-verify="required" placeholder="请输入ISBN" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
